...
const vec3 PYRAMID_POS(1.0f, -0.5f, -1.0f);
const vec4 PRISM_COLOR(0.28f, 0.09f, 0.47f, 1.0f);
const vec3 PRISM_POS(-0.8f, 0.5, 1.0f);
const vec4 BACKGROUND_COLOR(0.24f, 0.28f, 0.29f, 1.0f);
const vec3 LIGHT_POS1(-0.7f, 0.8f, 1.0f);
const vec4 LIGHT_COLOR1(1.0f, 1.0f, 1.0f, 1.0f);
const vec3 LIGHT_POS2(1.0f, 1.5f, -1.0f);
	...
	*/
	...
	while (!glfwWindowShouldClose(window)) {
		...
		*/
		...
		prismModel = rotate(prismModel, -10.0f * x, vec3(0.0f, 0.0f, 1.0f));
		prismModel = rotate(prismModel, 5.0f * y, vec3(0.0f, 1.0f, 0.0f));
